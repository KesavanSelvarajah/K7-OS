...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to JOSH Os modified by K7N!! type 'help' for further instructions", 0x00
	...
	strHelpMsg1		db  "Type version for get version",0x00
	strHelpMsg2		db  "Type info for to obtain Hardware informations of the machine",0x00
